      ...
      <article className="w-full md:w-1/2 flex justify-center md:items-center md:px-10">
        <div className="max-w-lg text-center md:text-left">
          ...
          <div className="flex justify-center md:justify-start mt-10 gap-10">
            <button className="w-auto bg-slate-900 rounded-xl px-8 py-2 cursor-pointer transition hover:bg-slate-600 hover:-translate-y-0.5 duration-200 hover:ease-in-out">
              View My Work
            </button>
            <button className="w-auto border border-slate-400 rounded-xl px-8 py-2 transition cursor-pointer hover:border-slate-600 hover:bg-slate-600/50 hover:-translate-y-0.5 duration-200 hover:ease-in-out">
              Contact Me
            </button>
          </div>
        </div>
